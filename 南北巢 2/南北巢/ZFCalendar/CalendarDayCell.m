...
- (void)initView{
    ...
    //价格
    day_price = [[UILabel alloc]initWithFrame:CGRectMake(0, self.bounds.size.height-15, self.bounds.size.width, 13)];
    day_price.textColor = [UIColor lightGrayColor];
    day_price.font = [UIFont boldSystemFontOfSize:10];
    day_price.textAlignment = NSTextAlignmentCenter;
